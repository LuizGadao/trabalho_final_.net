...
namespace Loja.DAL
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="ExemploBruno")]
    ...
    partial void DeleteProduto(Produto instance);
		...
		public LojaDataContext() : 
				base(global::Loja.DAL.Properties.Settings.Default.ExemploBrunoConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnDescricaoChanged();
		...
		[Column(Name="id_categoria", Storage="_Codigo", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Codigo
		{
			get
			{
		...
		[Column(Name="descricao_categoria", Storage="_Descricao", DbType="VarChar(50)")]
		...
		[Association(Name="tb_categoria_tb_produto", Storage="_Produtos", ThisKey="Codigo", OtherKey="CodigoCategoria")]
    ...
    partial void OnCodigoCategoriaChanged();
		...
		[Column(Name="id_produto", Storage="_Codigo", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Codigo
		{
			get
			{
		...
		[Column(Name="ds_produto", Storage="_Descricao", DbType="VarChar(50)")]
		public string Descricao
		{
			get
			{
		...
		[Column(Name="vl_preco", Storage="_Preco", DbType="Decimal(15,2)")]
		...
		[Column(Name="id_categoria", Storage="_CodigoCategoria", DbType="Int")]
		...
		[Association(Name="tb_categoria_tb_produto", Storage="_Categoria", ThisKey="CodigoCategoria", OtherKey="Codigo", IsForeignKey=true)]
